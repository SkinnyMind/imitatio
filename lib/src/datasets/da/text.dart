...
class DaTextData extends TextDataset {
  @override
  ...
  List<String> get levels {
    return const ["ekstrem", "høj", "kritisk", "lav", "meget høj", "moderat"];
  }
  ...
  List<String> get texts {
    return const [
      "Jeg har altid elsket at rejse og opleve nye steder.",
      "Vi har i dag besluttet at lukke butikken på grund af manglende kunder.",
      "Jeg har brugt hele dagen på at gøre rent i lejligheden.",
      "Det er vigtigt at huske, at man skal have en god forsikring, når man køber en bil.",
      "Vi har en stor have, hvor vi kan holde fester og arrangementer.",
      "Jeg har altid været interesseret i at lære nye sprog.",
      "Vi har i dag modtaget en stor ordre på 10.000 enheder.",
      "Jeg har brugt flere timer på at lave mad i dag.",
      "Det er vigtigt at huske, at man skal have en god uddannelse for at få et godt job.",
      "Vi har en lille hund, som hedder Max.",
    ];
  }
