...
class IslPersonData extends PersonDataset {
  @override
  ...
  List<String> get genders {
    return const ["Kvenkyns", "Karlkyn", "Annað"];
  }
  ...
  List<String> get occupations {
    return const ["Forritari", "Hönnuður", "Arkitekt"];
  }
  ...
  List<String> get viewsOn {
    return const ["Neikvæð", "Very neikvæð", "Jákvæð", "Hlutlaus"];
  }
