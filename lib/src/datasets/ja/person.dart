...
class JaPersonData extends PersonDataset {
  @override
  List<String> get academicDegrees {
    return const ["学士", "修士", "博士"];
  }

  @override
  List<String> get genders {
    return const ["男性", "女性", "その他"];
  }
  ...
  List<String> get politicalViews {
    return const ["無欲", "アナーキズム", "自由", "共産", "社会主義", "保守"];
  }
  ...
  List<String> get viewsOn {
    return const ["消極", "積極", "中立"];
  }

  @override
  List<String> get worldviews {
    return const ["無神論", "不可知論", "自然神論", "ユダヤ主義", "汎神論", "儒教", "世俗的人間主義"];
  }
}
