...
class EtPersonData extends PersonDataset {
  @override
  ...
  List<String> get occupations {
    return const [
      ...
      "Algebraist",
      "Algoloog",
      "Alkoholitootmisliini operaator",
      "Allergoloog",
      "Allmaajaoskonna juht",
      "Allohvitser",
      "Allveearheoloog",
      "Allveetööline",
      ...
      "Andmebaasi analüütik",
      "Andmebaasi projekteerija",
      "Andmesisestaja",
      "Anestesioloog",
      "Animatsioonide programmeerija",
      "Animatöör",
      "Apteeker",
      "Arendusjuht",
      "Arborist",
      ...
      "Arvestikontrolör",
      "Arvutihooldaja",
      "Arvutimängude programmeerija",
      "Arvutioperaator",
      "Arvutispetsialist",
      "Arvutiõpetaja",
      "Arvutiseadmete tehnik",
      "Arvutisüsteemi projekteerija",
      "Arvutisüsteemiinsener",
      "Arvutiteadlane",
      "Arvutivõrgu administraator",
      "Arvutivõrgu hooldaja",
      "Arvutivõrgu paigaldaja",
      "Asfaldilaoturi juht",
      "Asjaajaja",
      "Assessinaator",
      "Assistent",
      ...
      "Basskitarrist",
      "Betoneerija",
      "Betoonitootmise operaator",
      "Betoonivalmistaja",
      "Betooniviimistluse operaator",
      "Bibliograaf",
      "Bioanalüütik",
      "Bioinformaatik",
      "Biokeemik",
      ...
      "Voorimees",
      "Võistlustantsija",
      "Võlanõustaja – väliskommentaator",
      "Värval",
      "Õde",
      "Õmbleja",
      "Õpetaja",
