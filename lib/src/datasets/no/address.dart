...
class NoAddressData extends AddressDataset {
  @override
  ...
  List<String> get countries {
    return const [
      ...
      "Botswana",
      "Brasil",
      "Britiske territorier i Indiahavet",
      "Brunei",
      "Bulgaria",
      "Burkina Faso",
      "Burundi",
  ...
  List<String> streets({required bool isSuffix}) {
    return switch (isSuffix) {
      true => const ["allé", "vei", "plass", "gate"],
      false => const [
        "Aagots",
        "Aasmund Vinjes",
        "Abbediengen",
