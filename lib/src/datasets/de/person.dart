...
class DePersonData extends PersonDataset {
  @override
  List<String> get academicDegrees {
    return const ["Bachelor", "Diplom", "Master", "Doktor", "Professor"];
  }

  @override
  List<String> get genders {
    return const ["Andere", "Männlich", "Weiblich"];
  }
  ...
  List<String> titles({required Gender gender, required TitleType titleType}) {
    return switch (gender) {
      .female =>
        titleType == .academic
            ? const ["Dr.", "Dr. rer. nat.", "Dr. med.", "Prof. Dr."]
            : const ["Frau"],
      .male =>
        titleType == .academic
            ? const ["Dr.", "Dr. med.", "Dr. rer. nat.", "Prof. Dr."]
            : const ["Herr"],
    };
  }
