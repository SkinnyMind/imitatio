...
class EsMxAddressData extends AddressDataset {
  @override
  ...
  List<String> streets({required bool isSuffix}) {
    return switch (isSuffix) {
      ...
      false => const [
          ...
          "Curtidores",
          "De Guadalupe",
          "De Peñitas 1a Sección",
          "De Peñitas 2a Sección",
          "Del CECYTE",
          "Del Carmen",
          "Del Tepozán",
          "Del Trabajo",
          "Delegación de La Secretaria de Comercio y Fomento Industrial",
          "Diana",
          "Educación Álamos",
          "Ejido Ojocaliente",
          "Ejido las Cumbres",
          ...
          "Lomas de Nueva York",
          "Lomas de Oriente 1a Sección",
          "Lomas de Oriente 2da. Sección",
          "Lomas de Oriente 3ra. Sección",
          "Lomas de San Jorge",
          ...
          "Reencuentro",
          "Residencial Altaria",
          "Residencial Campestre Club de Golf Norte",
          "Residencial Campestre Club de Golf Sur",
          "Residencial Cosío",
