...
class NlBeTextData extends TextDataset {
  @override
  ...
  List<String> get quotes {
    return const [
      ...
      "Een goede naam is beter dan een goede erfenis.",
      "Wie zijn mond niet kan houden, kan zijn geheim niet bewaren.",
      "Een boom valt niet om door één enkele slag.",
      "Een goede vriend is beter dan een goede dokter.",
      "Wie zijn tijd niet kan delen, kan zijn geld niet delen.",
      "Een Belg zonder frieten is als een hond zonder staart.",
      "Wie niet kan lachen, kan niet leven.",
      "Een goede mop is beter dan een goede dokter.",
      "Wie zijn vrouw niet kan verdragen, kan zijn leven niet verdragen.",
      "Een Belg zonder bier is als een Nederlandse zonder kaas.",
    ];
  }
  ...
  List<String> get texts {
    return const [
      ...
      "Beter een fout maken dan niets doen.",
      ...
      "Dat is best goed.",
      "Dat is de vrouw die u wilt zien.",
      ...
      "Eens zult je de waarheid te weten komen.",
      ...
      "Erg bedankt voor al wat je gedaan hebt.",
      ...
      "Hebt je een fototoestel?",
      "Hebt je een vraag over deze les?",
      "Hebt je het boek al gelezen?",
      "Hebt je het niet koud?",
      "Hebt je iets over hem gehoord?",
      "Hebt je tijd om mij te helpen?",
      "Hebt u dit boek geschreven?",
      "Hebt u uw huiswerk al af?",
      ...
      "Het doet geen pijn.",
      "Het doet mij plezier dat je terug zijt.",
      ...
      "Hoe weet je dat?",
      "Hoe wilt je uw koffie?",
      "Hoe wilt u de eieren hebben?",
      "Hoe wist je dat hij getrouwd is?",
      "Hoe zeg je dat?",
      ...
      "Ik heb niet zo veel geld als je denkt.",
      ...
      "Ik weet niet de waarheid weten.",
      ...
      "Ik wil dat je gitaar speelt voor mij.",
      ...
      "Is het waar dat je naar Parijs gaat?",
      ...
      "Kunt je met de trein naar kantoor gaan?",
      "Kunt je u voorstellen hoe mijn leven is?",
      ...
      "Laat u uw kinderen koffie drinken?",
      ...
      "Over wat hebt je het eigenlijk?",
      "Over wie heb je het?",
      ...
      "Uw broer heeft mij gezegd dat je naar Parijs geweest zijt.",
      ...
      "Waar zult je morgen zijn op dit uur?",
      ...
      "Waarom komt je niet met ons mee?",
      "Waarom kunt je niet komen?",
      ...
      "Waarom vraag je dat?",
      "Waarom vraagt je dat, als je alles weet?",
      "Waarom vraagt u dat?",
      ...
      "Wanneer zijt je begonnen met Duits te leren?",
      ...
      "Wat je ook zegt, ik zal met haar trouwen.",
      ...
      "Wat hebt je gedaan deze week?",
      "Wat hebt je gisteravond gedaan?",
      "Wat hebt je nog meer op zak?",
      ...
      "Wat zoudt je doen in mijn plaats?",
      "Wat zult je worden?",
      "Wat, als ik arm ben?",
      ...
      "Weet je wat het is, echt honger hebben?",
      "Weet u waar hij woont?",
      "Weet hij dat je van hem houdt?",
      "Weet hij wat u gedaan hebt?",
      "Weet ik veel!",
      ...
      "Wel wel! Hoe hebt je dat gedaan?",
      "Welk jaar is het?",
      ...
      "Wilt je een tas koffie?",
      "Wilt je koffie of thee?",
      "Wilt je nog een tas koffie?",
      "Wilt je zo goed zijn het venster open te doen?",
      ...
      "Zeg me wat je wil.",
      "Zeg mij wat je op dat ogenblik gezien hebt.",
      ...
      "Zijt je al eens in Amerika geweest?",
      "Zijt je alleen naar hier gekomen?",
      "Zijt je allemaal klaar?",
      "Zijt je gestopt aan het rood licht?",
      "Zijt je niet beschaamd, zo te spreken?",
      "Zijt je niet gelukkig?",
      "Zijt je zeker?",
