...
class ArMaPersonData extends PersonDataset {
  @override
  ...
  List<String> get universities {
    return const [
      ...
      "جامعة ابن زهر",
      "جامعة الحسن الأول",
      "جامعة العلوم والتقنيات في فاس",
      "جامعة ابن طفيل",
      "جامعة محمد الأول",
      "جامعة المولى إسماعيل",
      "جامعة العلوم القانونية والاقتصادية والاجتماعية",
      "جامعة الرباط الدولية",
      "جامعة الدار البيضاء",
      "جامعة العيون",
      "جامعة المراكش",
      "جامعة القنيطرة",
