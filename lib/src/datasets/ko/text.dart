...
class KoTextData extends TextDataset {
  @override
  ...
  List<String> get quotes {
    return const [
      ...
      "남들이 우리와 다르게 살아가고 행동하며 경험한다는 사실을 알고 이에 기뻐하는 것이 사랑이 아니고 무엇이겠는가?",
      "누구도 본인의 동의없이 남을 지배할 만큼 훌륭하지는 않다.",
      "능력은 그 수요를 결코 충족시킬 수 없을 것이다.",
      "다른 사람들처럼 어떤 날은 자신이 예쁘게, 또 어떤 날은 그렇지 않게 느껴진다. 그렇지 않을 때는 조치를 취한다.",
      "만약 누군가를 당신의 편으로 만들고 싶다면, 먼저 당신이 그의 진정한 친구임을 확신시켜라.",
      "모두가 오래 살고 싶어하지만 아무도 늙고 싶어하지는 않는다.",
      "모든 인간은 개인으로서 존중받아야 하며, 그 누구도 우상으로 숭배해서는 안된다.",
      "모든 전사 중 가장 강한 전사는 이 두가지, 시간과 인내다.",
      ...
      "우리 모두는 인생의 격차를 줄여주기 위해 서있는 그 누군가가 있기에 힘든 시간을 이겨내곤 합니다.",
      ...
      "이 순간 살아 있어 모든 삶의 축복에 대한 경외심을 느끼곤 합니다.",
      "인간은 살아있기 위해 무언간에 대한 열망을 간직해야 한다.",
      ...
      "젊은이들은 세월이 어떻게 생각하고 느끼는 지 알턱이 없다. 그러나 노인이 젊은 시절을 망각하는 것은 죄이다.",
  ...
  List<String> get texts {
    return const [
      "나랏말싸미 듕귁에 달아 문자와를 서로 사맛디 아니할쎄 이런 전차로 어린백성이 니르고저 할빼 이셔도 마참내 제 뜻을 시러펴지 못할놈이 하니라.",
      "내이를 어여삐 녀겨 새로 스물여덟자를 맹가노니 사람마다해여 수비니겨 날로쓰매 편아케 하고저 할따라미니라.",
      "가는 말이 고와야 오는 말이 곱다.",
      "구슬이 서 말이라도 꿰어야 보배다.",
      "뛰는 놈 위에 나는 놈 있다.",
      "돌다리도 두들겨 보고 건너라.",
      ...
      "소학교때 책상을 같이 했던 아이들의 이름과, 패, 경, 옥, 이런 이국소녀들의 이름과, 벌써 아기 어머니된 계집애들의 이름과, 가난한 이웃 사람들의 이름과, 비둘기, 강아지, 토끼, 노새, 노루, '프랑시스 잠', '라이너 마리아 릴케' 이런 시인의 이름을 불러 봅니다.",
