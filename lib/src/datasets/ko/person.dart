...
class KoPersonData extends PersonDataset {
  @override
  List<String> get academicDegrees {
    return const ["학사", "석사", "박사"];
  }

  @override
  List<String> get genders {
    return const ["남자", "여자", "기타"];
  }
  ...
  List<String> get politicalViews {
    return const ["보수주의", "진보주의", "사회주의", "무정부주의", "극우", "극좌", "중도주의", "무관심"];
  }
  ...
  List<String> get viewsOn {
    return const ["매우 부정적", "부정적", "타협적", "중립적", "긍정적", "매우 긍정적"];
  }
