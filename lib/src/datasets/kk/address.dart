...
class KkAddressData extends AddressDataset {
  @override
  ...
  List<String> get countries {
    return const [
      ...
      "Сауд Арабиясы",
      "Сейшельдер",
      "Сен-Пиер және Микелон",
      "Сенегал",
      "Сент-Винсент және Гренадиндер",
      "Сент-Киттс және Невис",
      "Сент-Лусия",
      "Сербия",
      "Сиерра-Леоне",
      "Сингапур",
      ...
      "Уоллис және Футуна",
      "Уругвай",
      "Фарерлер Форояр Аралдары",
      "Фиджи",
      "Филиппиндер",
      "Финляндия",
      "Фолклендтер Фолкленд Аралдары",
      "Франция",
      "Хорватия",
      "Черногория",
      "Чехия",
      ...
      "Үндістан",
      "Ұлыбритания",
      "Ұлыбритания Акротири және Декелия",
      "Ұлыбритания Әскенжін Аралы",
      "Әзірбайжан",
      "Әулие Елена аралы",
      "Өзбекстан",
    ];
  ...
  List<String> streets({required bool isSuffix}) {
    return switch (isSuffix) {
      true => const ["орамы", "даңғылы", "желекжолы", "көшесі"],
      false => const [
        "8 наурыз",
        "Іле",
        "Іле  жолы",
        ...
        "Ілияс Жансүгірұлы",
        "Абай",
        "Абайдың 150 жылдығына берілген",
        "Абат-Байтақ",
        "Абдужаппаров",
        "Абдуллиндер",
        "Абхаз",
        ...
        "Бағаналы",
        "Бақтыгереев",
        "Бақтыораз Шәмпекұлы Бейсекбаев",
        "Бегалиев",
        "Бегалин",
        "Бедный",
        "Бейбітшілік",
        ...
        "Қазан",
        "Қазақбаев",
        "Қазақстан Республикасының Тәуелсіздігіне он жыл",
        "Қазыбаев",
        "Қазыбек би",
        "Қазыбеков",
        "Қазығұрт",
