...
class FiFinanceData extends FinanceDataset {
  @override
  ...
  List<String> get companies {
    return const [
      ...
      "Kuljetusliike e. laurila",
      "Kultasepänliike j. a. tarkiainen",
      "Kultasuklaa",
      "Kuntamaisema",
      "Kuntien tiera",
      "Kuusakoski",
      ...
      "Psycon",
      "Puuharyhmä",
      "Puuvillatehtaitten myyntikonttori",
      "Pyr",
      "Pyroll",
      "Pyroman finland",
