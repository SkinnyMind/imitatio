...
class TrFinanceData extends FinanceDataset {
  @override
  ...
  List<String> get companies {
    return const [
      ...
      "Arsan Tekstil Ticaret ve Sanayi",
      "Artı Yatırım",
      "Aselsan Elektronik",
      "Asil Çelik",
      "Aslan Çimento",
      "Ata",
      "Atakule",
      "Atlantik Petrol Ürünleri Ticaret ve Sanayi",
      "Atlantis Yatırım",
      "Atlas Menkul",
      "AvivaSA Emeklilik ve Hayat",
      "AVOD Kurutulmuş Gıda ve Tarım Ürünleri",
      "Avrasya",
      "Avrasya Petrol ve Turistik Tesisler Yatırımlar",
      "Avrupa Yatırım",
      "Ayen",
      "Ayes Çelik Hasır ve Çit Sanayi",
      "Aygaz",
      ...
      "Baştaş Başkent ve Ticaret",
      "Batıçim Batı Anadolu",
      "Batısöke Söke Çimento Sanayi Ticaret",
      "Berkosan Yalıtım ve Tecrit Maddeleri Üretim ve Ticaret",
      "Beşiktaş Futbol Yatırımları",
      "Beyaz Filo Oto Kiralama",
      "Bilici Yatırım",
      "BİM Birleşik Mağazalar",
      "Bimeks Bilgi İşlem ve Dış Ticaret",
      "Birko Birleşik Koyunlulular Mensucat Ticaret ve Sanayi",
      "Birlik Mensucat Ticaret ve Sanayi İşletmesi",
      "Bisaş Tekstil",
      "Bizim Toptan Satış Mağazaları",
      "Bolu",
      "Bomonti Elektirik Mühendislik Müşavirlik İnşaat Turizm ve Ticaret",
      "Borusan Mannesmann Boru",
      "Borusan Yatırım ve Pazarlama",
      "Bosch Fren Sistemleri",
      "Bossa Ticaret İşletmeleri",
      ...
      "Çemaş",
      "Çemtaş Çelik Makina",
      "Çimbeton Hazırbeton ve Prefabrik Yapı Malzemeleri",
      "Çimentaş İzmir Çimento Fabrikası Türk",
      "Çimsa Çimento",
      "Çuhadaroğlu Metal Sanayi ve Pazarlama",
      "Dagi Giyim",
      "Dagi Yatırım",
      "Dardanel Önentaş",
      "Datagate Bilgisayar Malzemeleri Ticaret",
      "Demisaş Döküm Emaye Mamülleri Sanayi",
      "Denge Yatırım",
      "Deniz",
      "Denizbank",
      "Denizli Cam",
      "Derimod Konfeksiyon Ayakkabı Deri",
      "Desa Deri",
      "Despec Bilgisayar Pazarlama ve Ticaret",
      "Deva",
      ...
      "Erbosan Erciyes ve Ticaret",
      "Ereğli Demir ve Çelik Fabrikaları",
      "Ersu Meyve ve Gıda Sanayi",
      "Escort Teknoloji Yatırım",
      "Esem Spor Giyim ",
      "Etiler Gıda ve Ticari Yatırımlar",
      "Euro Finans Menkul Değerler",
      "Federal Mogul İzmit Piston ve Pim Üretim Tesisleri",
      "Fenerbahçe Futbol",
      "Finans Finansal Kiralama",
      "Finansbank",
      "Flap Kongre Toplantı Hizmetleri Otomotiv ve Turizm A.Ş",
      "Ford Otomotiv Sanayi",
      "Frigo-Pak Gıda Maddeleri",
      "Galatasaray Sportif Sınai ve Ticari Yatırımlar",
      "Garanti Faktoring ",
      "Gedik Girişim",
      "Gedik Yatırım",
      ...
      "Gen Yatırım",
      "Gentaş Genel Metal",
      "Gersan Elektrik Ticaret ve Sanayi",
      ...
      "Halk",
      "Halk Sigorta",
      "Hateks Hatay Tekstil İşletmeleri",
      "Hedef Girişim",
      "Hektaş Ticaret",
      ...
      "İntema İnşaat ve Tesisat Malzemeleri Yatırım ve Pazarlama",
      "İpek Doğal",
      ...
      "İşbir",
      "İttifak",
      "İz Hayvancılık Tarım ve Gıda Sanayi Ticaret",
      ...
      "Karsan ve Ticaret",
      "Karsu ve Ticaret",
      "Karsusan Karadeniz Su",
      "Kartonsan ve Ticaret",
      "Katmerciler Araç Üstü Ekipman",
      "Kent Gıda ve Ticaret",
      "Kerevitaş Gıda",
      "Kervansaray Yatırım",
      "Kiler",
      "Klimasan Klima",
      ...
      "Körfez",
      "Kristal Kola Meşrubat",
      "Kron",
      "Kuştur Kuşadası Turizm Endüstrisi",
      "Kuyumcukent Gayrimenkul Yatırımları",
      "Kütahya Porselen Sanayi",
      "Lider Faktoring Hizmetleri",
      "Link Bilgisayar Sistemleri Yazılımı ve Donanımı San. ve Tic.",
      "Logo Yazılım",
      "Lokman Hekim Engürüsağ Sağlık Turizm Eğitim Hizmetleri ve İnşaat Taahhüt",
      "Lüks Kadife Ticaret",
      ...
      "Mazhar Zorlu",
      "MCT Danışmanlık A.Ş",
      "Mega Polietilen Köpük Sanayi veTicaret",
      "Menba",
      "Menderes Tekstil",
      "Mensa Sınai Ticari ve Mali Yatırımlar",
      "Mepet Metro Petrol ve Tesisleri",
      "Merit Turizm Yatırım ve İşletme",
      "Merko Gıda",
      "Metal Gayrimenkul",
      ...
      "Mondi Tire Kutsan Kağıt ve Ambalaj Sanayi",
      "Net",
      ...
      "Nuh",
      "Nurol",
      "Odaş Elektrik Üretim Sanayi Ticaret",
      "Olmuksan International Paper Ambalaj",
      "Orge",
      "Orma Orman Mahsulleri Integre ",
      "Osmanlı Menkul Değerler",
      "Ostim Endüstriyel Yatırımlar ve İşletme",
      "Otokar Otomotiv ve Savunma Sanayi",
      "Oylum Sınai Yatırımları",
      "Özak",
      "Özbal Çelik Boru Sanayi Ticaret ve Taahhüt",
      "Özderici",
      "Özerden Plastik",
      "Panora",
      "Park Elektrik Üretim Madencilik",
      "Parsan Makina Parçaları Sanayi",
      ...
      "Pınar Su",
      "Pınar Süt",
      "Pimaş Plastik İnşaat Malzemeleri",
      "Plastikkart Akıllı Kart İletişim Sistemleri",
      "Polisan",
      "Politeknik Metal",
      "Prizma Pres Matbaacılık Yayıncılık Sanayi ve Ticari",
      "Ray Sigorta",
      "Reysaş",
      "Reysaş Taşımacılık ve Lojistik Ticaret",
      "Rhea Girişim",
      "Rodrigo Tekstil",
      "Royal Halı İplik Tekstil Mobilya",
      "RTA Laboratuvarları Biyolojik Ürünler İlaç ve Makina",
      "SAN-EL Mühendislik Elektrik Taahhüt",
      "Sanifoam Sünger",
      "Sanko Pazarlama İthalat İhracat",
      "Saray Matbaacılık Kağıtçılık Kırtasiyecilik Ticaret ve Sanayi",
      "Sarkuysan Elektrolitik Bakır",
      "Sasa Polyester Sanayi",
      "Say Reklamcılık Yapı Dekorasyon Proje Taahhüt A.Ş",
      "Sekuro Plastik Ambalaj Sanayi",
      "Selçuk Ecza Deposu Ticaret ve Sanayi",
      "Selçuk Gıda Endüstri İhracat İthalat",
      ...
      "Sodaş",
      "Söktaş Tekstil ",
      "Sönmez Filament Sentetik İplik ve",
      "Sönmez",
      "Şeker Finansal Kiralama",
      "Şekerbank",
      "Tacirler Yatırım Holdin",
      "Taç Tarım Ürünleri Hayvancılık Gıda",
      "Tat Gıda Sanayi",
      "TAV Havalimanları",
      "Taze Kuru Gıda A.Ş",
      "Tek-Art İnşaat Ticaret Turizm Sanayi ve Yatırımlar",
      "Tekfen",
      "Teknosa İç ve Dış Ticaret",
      "Te-Mapol Polimer Plastik ve İnşaat",
      "Tesco Kipa Kitle Pazarlama Ticaret ve",
      "TGS Dış Ticaret",
      ...
      "Transtürk",
      "TSKB",
      "Tuğçelik Alüminyum ve Metal Mamülleri Sanayi ve Ticater",
      "Tukaş Gıda",
      "Turcas Petrol",
      ...
      "Türk Prysmian Kablo ve Sistemleri",
      "Türk",
      "Türk Traktör ve Ziraat Makineleri",
      "Türk Tuborg Bira ve",
      "Türker Proje Gayrimenkul ve Yatırım Geliştirme",
      ...
      "Ulaşlar Turizm Yatırımları ve Dayanıklı Tüketim Malları Ticaret Pazarlama A.Ş",
      "Ulusoy Elektrik İmalat Taahhüt ve Ticaret",
      "Ulusoy Un",
      "Umpaş",
      "USAŞ Yatırımlar",
      "Uşak Seramik Sanayi",
      "Utopya Turizm İnşaat İşletmecilik Ticaret",
      "Uzertaş Boya Sanayi Ticaret ve Yatırım",
      "Ülker Bisküvi Sanayi",
      "Ünye ve Ticaret",
      "Vakıf Finansal Kiralama",
      "Vakıf",
      "Vakıf Menkul",
      "Vakko Tekstil ve Hazır Giyim Sanayi İşletmeleri",
      "Vanet Gıda Sanayi İç ve Dış Ticaret",
      "Verusa",
      "Verusatürk Girişim",
      "Vestel Beyaz Eşya",
      "Vestel Elektronik",
      ...
      "Yeni Gimat ",
      "Yeşil",
      "Yeşil Yapı Endüstrisi",
      "Yeşil Yatırım",
      "Yibitaş Yozgat İşçi Birliği İnşaat Malzemeleri Ticaret ve Sanayi",
      "Yonga Mobilya",
      "Yünsa Yünlü",
      "Zorlu",
    ];
