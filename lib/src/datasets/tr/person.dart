...
class TrPersonData extends PersonDataset {
  @override
  List<String> get academicDegrees {
    return const ["Ön Lisans", "Lisans", "Yüksek Lisans", "Doktora"];
  }

  @override
  List<String> get genders {
    return const ["Erkek", "Kadın", "Diğer"];
  }
  ...
  List<String> get viewsOn {
    return const ["Negatif", "Çok Negatif", "Pozitif", "Normal", "Dayanabilir"];
  }
