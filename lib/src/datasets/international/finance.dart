class IntFinanceData {
  const IntFinanceData._();

  static const currencyIsoCodes = <String>[
    "AED",
    "AFN",
    "ALL",
    "AMD",
  ...
  static const cryptocurrencyIsoCodes = <String>[
    "BCH",
    "BNB",
    "BTC",
    "DASH",
  ...
  static const stockNames = <String>[
    "1-800 FLOWERS.COM",
    "10x Genomics",
    "111",
    ...
    r"iShares iBoxx $ High Yield ex Oil & Gas Corporate Bond ETF",
    "iStar Inc.",
    "icad inc.",
    "inTest Corporation",
    "j2 Global",
  ...
  static const stockExchanges = <String>[
    "NYSE",
    "NASDAQ",
    "AMEX",
    "JPX",
