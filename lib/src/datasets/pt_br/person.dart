...
class PtBrPersonData extends PersonDataset {
  @override
  ...
  List<String> get genders {
    return const ["Masculino", "Feminino", "Transgênero", "Outro"];
  }
  ...
  List<String> titles({required Gender gender, required TitleType titleType}) {
    return switch (gender) {
      .female =>
        titleType == .academic ? const ["Dr.", "Prof."] : const ["Sra."],
      .male => titleType == .academic ? const ["Dr.", "Prof."] : const ["Sr."],
    };
  }
  ...
  List<String> get universities {
    return const [
      ...
      "Instituto Federal de Braília (IFB)",
      ...
      "Univesidade do Alto Vale do Rio do Pixe (UNIARP)",
      "Uppsala University",
      "Utrecht University",
