...
class CsPersonData extends PersonDataset {
  @override
  ...
  List<String> get genders {
    return const ["Feminine", "Masculine", "Neuter"];
  }
  ...
  List<String> get occupations {
    return const [
      ...
      "Asistent soudce",
      "Asistent v médiích, reklamě a PR",
      ...
      "Odborný asistent",
      "Odborný asistent ve výzkumu a vývoji",
      "Odhadce",
      "Office manager",
      "Oftalmolog",
      "Onkolog",
      ...
      "Specialista mobilních technologií",
      ...
      "Specialista zabezpečovacích zařízení",
      "Speciální pedagog",
      "Speditér",
      "Spojový manipulant",
      "Sportovní lékař",
      ...
      "Technolog v plynárenství",
      "Technolog v telekomunikacích",
      ...
      "Zahradní architekt",
      "Zahradník",
      "Zaměstnanec provozu restaurace",
      "Zdravotní sestra",
      "Zedník",
      "Zkušební technik",
      "Zlatník",
  ...
  List<String> get politicalViews {
    return const ["Anarchismus", "Anarchokomunismus", "Liberalismus"];
  }
  ...
  List<String> get viewsOn {
    return const ["Negativy", "Neutrální", "Pozitivní"];
  }
