...
class CsAddressData extends AddressDataset {
  @override
  ...
  List<String> streets({required bool isSuffix}) {
    return switch (isSuffix) {
      ...
      false => const [
        ...
        "Čsl. Armády",
        "Čsl. Dobrovolců",
        "Čsl. Maďar. Přátelství",
        "Čsl. Maďarského Přátelství",
        "Čsl. Červeného Kříže",
        "Čsla",
        "Čtvrť J. Hybeše",
        "Číchovská",
