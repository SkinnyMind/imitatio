...
class RuPersonData extends PersonDataset {
  ...
  @override
  Map<String, List<String>> get nationality {
    return const {
      "female": [
        "Русская",
        "Белоруска",
  ...
  @override
  Map<String, List<String>> get surnames {
    return const {
      "male": [
        "Абакумов",
        "Абдуллаев",
  ...
  @override
  Map<String, Map<String, List<String>>> get title {
    return const {
      "female": {
        "typical": [
          "Мисс",
  ...
  List<String> get university {
    return const [
      ...
      "СПбГУ",
      "Госуниверситет нефти и газа имени Губкина",
      ...
      "Госуниверситет гражданской авиации",
      "Авиационно-технический университетАвиационно-технический университет",
    ];
  }
