...
class RuTextData extends TextDataset {
  @override
  ...
  List<String> get answers {
    return const ["Да", "Нет", "Возможно", "Неизвестно"];
  }
  ...
  List<String> get quotes {
    return const [
      ...
      "Валяй, порадуй меня!",
      "Хорошо, г-н Демилль, я готова для крупного плана.",
      ...
      "Ко мне обращаются “Мистер Тиббс”.",
      "Розовый бутон (или бутон розы).",
      "Я достиг этого, мам! Я на вершине мира!",
      ...
      "Я тут иду! Я тут иду!",
      "Сыграй это, Сэм. Сыграй 'As Time Goes By.' (Сыграй, Сэм, сыграй… “В память о былых временах”).",
      "Правда тебе не по зубам.",
      "Я хочу побыть одна.",
      "В конце концов, завтра — другой день!",
      "Арестуйте обычных подозреваемых.",
      "Мне — то же, что и ей.",
      "Вы знаете как свистеть, не так ли, Стив? Вы просто соединяете губы и дуете.",
      "Тебе нужна будет лодка побольше.",
      "Нагрудные знаки? Нет у нас никаких знаков! Не нужны нам никаких знаков! Я не должен показывать вам никакие чёртовы знаки!",
      "Я вернусь.",
      ...
      "Стелла! Эй, Стелла!",
      "О, Джерри, давай не мечтать о луне: у нас есть звезды.",
      "Шейн. Шейн. Вернись!",
      "Что ж, у каждого свои недостатки.",
      "Оно живое! Живое!",
      "Хьюстон, у нас проблема.",
      "Ты должен задать себе один вопрос: «Повезёт ли мне?» Ну что, повезёт, подонок?",
      "Я была твоя уже на «здрасьте».",
      "Одним утром я подстрелил слона в собственной пижаме. Как он оказался в моей пижаме, я не знаю.",
      "Никто не плачет в бейсболе!",
      "Ла-дии-да, ла-дии-да.",
      "Лучший друг парня — это его мать.",
      "Жадность, за отсутствием более подходящего слова — это хорошо.",
      ...
      "Прекращай это!",
      "Моя мать благодарит вас. Мой отец благодарит вас. Моя сестра благодарит вас. И я благодарю вас.",
      "Никто не задвинет Малышку в угол.",
