...
class ItTextData extends TextDataset {
  @override
  ...
  List<String> get quotes {
    return const [
      ...
      "Al fresco.",
      "Altro che!",
      "Amor e signoria non vogliono compania.",
      ...
      "Che sarа sarа.",
      "Che talor cresce una beltа un bel manto.",
      ...
      "La povertа è la madre di tutte le arti.",
