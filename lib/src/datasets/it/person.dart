...
class ItPersonData extends PersonDataset {
  @override
  List<String> get academicDegrees {
    return const ["Laurea breve", "Laurea magistrale", "Dottorato"];
  }

  @override
  List<String> get genders {
    return const ["Maschio", "Femmina", "Neutro"];
  }
  ...
  List<String> titles({required Gender gender, required TitleType titleType}) {
    return switch (gender) {
      .female =>
        titleType == .academic
            ? const ["Dott.", "Avv.", "Ing.", "Dr."]
            : const ["Signorina", "Signora", "Sig.ra"],
      .male =>
        titleType == .academic
            ? const ["Dott.", "Avv.", "Ing.", "Dr."]
            : const ["Signore", "Sig."],
  ...
  List<String> get viewsOn {
    return const ["Negativo", "Molto negativo", "Positivo", "Neutro"];
  }
