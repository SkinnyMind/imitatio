...
class SvTextData extends TextDataset {
  @override
  ...
  List<String> get levels {
    return const ["låg", "måttlig", "hög", "mycket hög", "extrem", "kritisk"];
  }
  ...
  List<String> get texts {
    return const [
      ...
      "Eftersom språket är designat för parallell bearbetning på flera sammankopplade system är det också synnerligen väl lämpat för användning på moderna multicore-maskiner.",
      ...
      "Lorem ipsum visar hur layout, teckensnitt och typografi samspelar, utan att texten, undermedvetet genom ordens betydelse, ska påverka betraktaren.",
      ...
      "Träutensilierna i ett tryckeri äro ingalunda en oviktig faktor, för trevnadens ordningens och och dock är det icke sällan.",
