...
void main() {
  group('Science', () {
    ...
    test('returns dna sequence', () async {
      expect(science.dnaSequence().length, equals(10));
      expect(science.dnaSequence(lenght: 3).length, equals(3));
      expect(
        seededScience.dnaSequence(),
        equals(seededScience.dnaSequence()),
      );
    });

    test('returns measure unit', () async {
      ...
      expect(
        seededScience.measureUnit(),
        equals(seededScience.measureUnit()),
      );
    });

    test('returns metric prefix', () async {
